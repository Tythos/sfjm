...
if (typeof(define) == "undefined") { 
    function define(callback) { callback(require, exports, module); }
}
define(function(require, exports, module) {
    // we don't use it, but let's demonstrate a dependency load just for shiggles
    let txtloader = require("lib/txtloader-v1.0.0.js");
    ...
    Object.assign(exports, {
        ...
        "main": function() { let a = new AnAwesomeNumber(2); a.doStuff(); },
